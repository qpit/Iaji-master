...
class PIDControlWidget(QWidget):
    def __init__(self):
        ...
        for parameter in self.parameters:
            ...
            setattr(self, parameter + "_slider", QSlider(Qt.Vertical))  # create a slider to set the value
            ...
            getattr(self, parameter + "_layout").addWidget(getattr(self, parameter + "_slider"))  # Add the slider widget to the current layout
    ...
    def set_style(self, theme):
        ...
        for widget_type in ["label", "slider"]:
