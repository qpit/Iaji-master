...
#%%
def covariance_matrix_EB_ideal_transmitter(variances_A, correlations_A, state_monitor = None):
    """
...
def loss(V_0, eta):
    """
    Transform the initial variance V_0 of a Gaussian state, according to
    propagation loss with efficiency eta
    """
    return eta*V_0 + (1-eta)
